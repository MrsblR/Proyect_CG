#include "Pattern.hpp"
// Calcula la pose del patrón utilizando la calibración de la cámara y los puntos 2D y 3D del patrón.
...
// Dibuja el contorno 2D del patrón en la imagen con el color especificado.
