...
#include <gl/gl.h>
#include <gl/glu.h>
// Función de callback para el dibujo en OpenGL
...
// Método principal de dibujo que limpia el buffer y dibuja el fondo y la escena aumentada.
...
// Dibuja el frame de la cámara en la ventana OpenGL.
void ARDrawingContext::drawCameraFrame()
{
  ...
  glBindTexture(GL_TEXTURE_2D, m_backgroundTextureId);
  // Configura la textura en función del número de canales.
...
// Dibuja la escena aumentada si se detecta un patrón.
...
// Construye la matriz de proyección en función de la calibración de la cámara y el tamaño de la pantalla.
